...
import zhy.hongyuan.util.utils.BitmapUtil;
import zhy.hongyuan.util.utils.FileUtils;
import zhy.hongyuan.util.utils.GsonExtensionsKt;
import zhy.hongyuan.util.utils.MeUtils;
import zhy.hongyuan.widget.page.PageMode;

import static zhy.hongyuan.common.APPCONST.READ_STYLE_BLUE_DEEP;
import static zhy.hongyuan.common.APPCONST.READ_STYLE_BREEN;
import static zhy.hongyuan.common.APPCONST.READ_STYLE_COMMON;
import static zhy.hongyuan.common.APPCONST.READ_STYLE_LEATHER;
import static zhy.hongyuan.common.APPCONST.READ_STYLE_NIGHT;
import static zhy.hongyuan.common.APPCONST.READ_STYLE_PROTECTED_EYE;
import static zhy.hongyuan.widget.page.PageLoader.DEFAULT_MARGIN_WIDTH;
...
public class Setting implements Serializable {
    ...
    public boolean exportLayout(int index){
        ...
        try {
            ZipUtils.zipFiles(filesPath, APPCONST.FILE_DIR + "readConfig.zip", "熊猫读书 布局导出配置");
