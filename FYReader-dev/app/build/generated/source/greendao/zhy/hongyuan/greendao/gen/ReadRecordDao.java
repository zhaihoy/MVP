...
*/
public class ReadRecordDao extends AbstractDao<ReadRecord, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(ReadRecord entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(ReadRecord entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
