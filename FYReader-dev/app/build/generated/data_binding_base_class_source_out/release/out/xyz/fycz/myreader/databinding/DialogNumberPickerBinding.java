...
public final class DialogNumberPickerBinding implements ViewBinding {
  ...
  private DialogNumberPickerBinding(@NonNull LinearLayout rootView,
  ...
  public static DialogNumberPickerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      NumberPicker numberPicker = rootView.findViewById(id);
      if (numberPicker == null) {
        break missingId;
      }

      return new DialogNumberPickerBinding((LinearLayout) rootView, numberPicker);
    }
