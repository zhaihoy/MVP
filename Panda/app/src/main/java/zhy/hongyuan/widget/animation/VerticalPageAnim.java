...
package zhy.hongyuan.widget.animation;
...
public abstract class VerticalPageAnim extends PageAnimation{
    ...
    public VerticalPageAnim(int w, int h, View view, OnPageChangeListener listener) {
        this(w, h, 0, 0,0, view, listener);
    }

    public VerticalPageAnim(int w, int h, int marginWidth, int marginTop, int marginBottom,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                if (!isMove){
                    isNext = y > mScreenHeight / 2 || SysManager.getSetting().isAlwaysNext();
