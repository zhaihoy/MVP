...
public class EpubPageLoader extends PageLoader {
    ...
    EpubPageLoader(PageView pageView, zhy.hongyuan.greendao.entity.Book bookShelfBean, Setting setting) {
    ...
    public void refreshChapterList() {
        ...
        Observable.create((ObservableOnSubscribe<zhy.hongyuan.greendao.entity.Book>) e -> {
            ...
            e.onComplete();
                ...
                .subscribe(new MyObserver<zhy.hongyuan.greendao.entity.Book>() {
                    @Override
                    ...
                    @Override
                    public void onNext(zhy.hongyuan.greendao.entity.Book bookShelfBean) {
    ...
    private Observable<zhy.hongyuan.greendao.entity.Book> checkChapterList(zhy.hongyuan.greendao.entity.Book collBook) {
