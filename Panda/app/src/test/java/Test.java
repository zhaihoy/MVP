...
import zhy.hongyuan.model.sourceAnalyzer.BaseAnalyzer;
...
public class Test {
    ...
    public void testXpath() throws UnsupportedEncodingException {
        String str = new String(FileUtils.getBytes(new File("D:\\Java\\Project\\panda-master\\app\\src\\test\\resources\\html.html")), "GBK");
